...
namespace lp2_rec_ghosts.Model
{
    public class GameBoard
    {
        ...
        /// </typeparam>
        /// <typeparam name="BoardObject[]"> An array of all the objects
        ...
        public Dictionary<Vector, BoardObject[]> Board 
            {get; private set;} = new Dictionary<Vector, BoardObject[]>();
        ...
        public void BuildBoard()
        {
            ...
            for(int i = 1; i < 6; i++)
            {
                Board.Add(new Vector(i,0), new BoardObject[3]
            ...
            // Top Row
            Board.Add(new Vector(1,5), new BoardObject[3]
                {new CarpetTile(Colors.BLUE), null, null});
            Board.Add(new Vector(2,5), new BoardObject[3]
                {new CarpetTile(Colors.RED), null, null});
            Board.Add(new Vector(4,5), new BoardObject[3]
                {new CarpetTile(Colors.BLUE), null, null});
            Board.Add(new Vector(5,5), new BoardObject[3]
                {new CarpetTile(Colors.RED), null, null});
            ...
            // 3rd Row
            Board.Add(new Vector(1,3), new BoardObject[3]
                {new CarpetTile(Colors.RED), null, null});
            Board.Add(new Vector(2,3), new BoardObject[3]
                {new CarpetTile(Colors.BLUE), null, null});
            Board.Add(new Vector(3,3), new BoardObject[3]
                {new CarpetTile(Colors.RED), null, null});
            Board.Add(new Vector(4,3), new BoardObject[3]
                {new CarpetTile(Colors.BLUE), null, null});
            ...
            // 1st Row
            Board.Add(new Vector(1,1), new BoardObject[3]
                {new CarpetTile(Colors.YELLOW), null, null});
            Board.Add(new Vector(2,1), new BoardObject[3]
                {new CarpetTile(Colors.RED), null, null});
            Board.Add(new Vector(4,1), new BoardObject[3]
                {new CarpetTile(Colors.BLUE), null, null});
            Board.Add(new Vector(5,1), new BoardObject[3]
                {new CarpetTile(Colors.YELLOW), null, null});
        }
    }
}